...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3054cb543409b40f3be98e0f698e5538) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Frame_events"];
                      lib_findlib_parent = Some "bap-traces";
                      lib_findlib_name = Some "plugin";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bap", None);
                           InternalLibrary "bap-traces";
                           InternalLibrary "bap-traces-plugin";
                   ...
                   {exec_custom = false; exec_main_is = "tracedump.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\164\182\148p\1876\204\142d\176@]:\012\147\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
