(* OASIS_START *)
(* DO NOT EDIT (digest: 640305e6bea76b78dbf5ed21d98a0678) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Frame_events"; "Frame_piqi"; "Frame_reader"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "8\238\023\210y\197\144V\b\229s\2451\r8\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
