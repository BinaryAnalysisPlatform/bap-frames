...
(* OASIS_START *)
(* DO NOT EDIT (digest: bfbcce5e8ffbdc49960ff66d02d0cd74) *)
(*
...
let setup_t =
  {
          ...
          install_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["piqi/cleanup.sh"])))]
            };
          uninstall_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Stmt_piqi"; "Bil_piqi"];
                      lib_pack = false;
                      lib_internal_modules = ["Stmt_piqi_ext"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "h,[q\245R\203)\200\145\017\242\162\212e-";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
