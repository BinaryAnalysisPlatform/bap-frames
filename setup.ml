(* OASIS_START *)
(* DO NOT EDIT (digest: e03f68c945ea73d32f9b986f114490b9) *)
(*
   Regenerated by OASIS v0.4.12
   Visit https://github.com/ocaml/oasis for more information and
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$run_frames_tests", ["-runner"; "sequential"]))
                   ];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bap", None);
                           FindlibPackage ("bap-traces", None);
                           FindlibPackage ("core_kernel", None);
                           FindlibPackage
                             ("core_kernel.binary_packing", None);
                           FindlibPackage ("piqirun.pb", None);
                           FindlibPackage ("ppx_jane", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "piqi"];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "bap-frames";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "bap-plugin-frames";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Frame_trace_plugin"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "bap-plugin-frames";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "frames-tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Test_enum"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "bap-frames-tests";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "run_frames_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "frames-tests"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "run_frames_tests.ml"
                   });
               Test
                 ({
                     cs_name = "unit_tests";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "run_frames_tests"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.12";
     oasis_digest =
       Some "~\026!)\128\156\243\136\183\200\001\170\147>\249\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
